...
export default {
  ...
  'sp.thinking.prefix': 'Think:',
  'sp.thinking.title': 'Thinking strength: {level} — click to cycle',
  ...
  'st.display.download_directory.desc': 'Where model-triggered downloads are saved: a relative subfolder inside your browser or system Downloads directory, or an absolute Windows path such as D:/images (the folder must already exist). Leave blank to use the system default.',
  'st.display.download_directory.placeholder': 'System default',
  'st.display.download_directory.error': 'Use a relative folder such as WebBrain or Work/WebBrain, or an absolute Windows drive path such as D:/images. ".." is not allowed.',
  'st.display.workspace_whitelist.label': 'Working directory whitelist',
  'st.display.workspace_whitelist.desc_html': 'Extra local folders granted to the agent: it may <b>read</b> them and <b>move files out</b> of them into the working directory (workspace_whitelist_list / workspace_copy_in). Typical use: blocker sites that only accept a virtual-click download drop files into Chrome\'s default Downloads folder — add the Downloads folder here and the agent can move those files into the working directory automatically.<br>Note: after a browser restart, click "Re-authorize" for each folder.',
  'st.display.workspace_whitelist.add': 'Add folder',
  ...
  'st.skills.saved': 'Changes saved.',
  'st.skills.editing': 'Editing: {name} — click Save changes below when done.',
  ...
  'st.persona.heading': 'Assistant persona',
  'st.persona.desc_html': 'A custom identity and behavior block for the agent. It is appended to the system prompt <strong>right after the base prompt</strong> on every conversation, in every mode. Leave empty to disable.',
  'st.persona.text.label': 'Persona text',
  'st.persona.text.placeholder': 'Your name is "WebBrain Assistant". You run inside the user\'s own browser.\n- Always answer in the user\'s language, conclusion first.\n- Be concise; never list your capabilities unless asked.',
  'st.persona.save': 'Save',
  'st.persona.clear': 'Clear',
  'st.persona.saved': 'Saved.',
  'st.persona.cleared': 'Cleared.',
